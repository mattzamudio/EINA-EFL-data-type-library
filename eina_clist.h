 ...
 * - Allows removal of items without knowing which list they're in while using O(1) time.
 ...
 * @endcode
 *
 * Iterate over a list as follows:
 *
 * @code
 ...
 * @pre The list head must be initialized once before anything can be added.
 ...
 *
 * @param[in] elem An element.
 * @return TRUE if the element is in a list. Otherwise, FALSE.
 ...
 * @note This function must be called. Do not try to
 ...
 *
 * @param[in,out] dst The list to be appended.
 ...
 *
 * @param[in,out] dst The list to be prepended.
 ...
 * @brief Iterates through the list with a safety against removal.
 *
 * @param[out] cursor The pointer to be used during the interaction.
 ...
 * @brief Iterates through the list using a list entry with a safety against removal.
 *
 * @param[out] cursor The pointer to be used during the interaction.
 * @param[out] cursor2 The auxiliary pointer to be used during the interaction.
 * @param[in] list The list to be interacted with.
 ...
 * @brief Iterates through the list in the reverse order with a safety against removal.
 *
 * @param[out] cursor The pointer to be used during the interaction.
 * @param[out] cursor2 The auxiliary pointer to be used during the interaction.
 * @param[in] list The list to be interacted with.
 ...
 * @brief Iterates through the list in the reverse order using a list entry with a safety against
 *        removal.
 *
 * @param[out] cursor The pointer to be used during the interaction.
 * @param[out] cursor2 The auxiliary pointer to be used during the interaction.
